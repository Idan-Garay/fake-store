        ...
        <main className='w-full h-[100vh] border flex flex-col items-center justify-center flex-grow-0'>
            <div className=" h-4/6 w-5/12 py-12 px-24 rounded border flex flex-col gap-y-6">
                ...
                <div className="input-group flex flex-col">
                    ...
                    <input type="email" onChange={e => setEmail(e.target.value)} defaultValue={email} name="email" id="email" className='border rounded h-9 p-2' />
                </div>
                <div className="input-group flex flex-col">
                    <label htmlFor="password">Password</label>
                    <input type="password" onChange={e => setPassword(e.target.value)} defaultValue={password} name="password" id="password" className='border rounded h-9 p-2' />
                </div>
